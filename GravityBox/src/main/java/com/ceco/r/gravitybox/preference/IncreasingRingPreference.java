...
public class IncreasingRingPreference extends VolumePreference implements
    ...
    protected void onBindDialogView(View view) {
        ...
        mEnabledCheckbox = view.findViewById(R.id.increasing_ring);
        mEnabledCheckbox.setOnCheckedChangeListener(this);

        mMinVolumeTitle = view.findViewById(R.id.increasing_ring_min_volume_title);

        mMinVolumeSeekBar = view.findViewById(R.id.seekbar);
        AudioManager am = (AudioManager) getContext().getSystemService(Context.AUDIO_SERVICE);
        mMinVolumeSeekBar.setSecondaryProgress(am.getStreamVolume(AudioManager.STREAM_RING));

        mRingVolumeNotice = view.findViewById(R.id.increasing_ring_volume_notice);

        mIntervalTitle = view.findViewById(R.id.increasing_ring_ramp_up_duration_title);
        mInterval = view.findViewById(R.id.increasing_ring_ramp_up_duration);
