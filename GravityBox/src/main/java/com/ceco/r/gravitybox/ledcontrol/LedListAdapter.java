...
import com.ceco.r.gravitybox.adapters.BaseListAdapterFilter;
import com.ceco.r.gravitybox.adapters.BaseListAdapterFilter.IBaseListAdapterFilterable;
...
public class LedListAdapter extends ArrayAdapter<LedListItem>
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(row == null) {
            ...
            holder.appIconView = row.findViewById(R.id.led_app_icon);
            holder.appNameView = row.findViewById(R.id.led_app_name);
            holder.pkgNameView = row.findViewById(R.id.led_pkg_name);
