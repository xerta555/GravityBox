...
import com.ceco.r.gravitybox.ledcontrol.LedMainActivity;
import com.ceco.r.gravitybox.ledcontrol.LedSettings;
import com.ceco.r.gravitybox.managers.SysUiBatteryInfoManager;
import com.ceco.r.gravitybox.preference.AppPickerPreference;
import com.ceco.r.gravitybox.preference.SeekBarPreference;
import com.ceco.r.gravitybox.quicksettings.TileOrderActivity;
import com.ceco.r.gravitybox.shortcuts.ShortcutActivity;
import com.ceco.r.gravitybox.tuner.TunerMainActivity;
import com.ceco.r.gravitybox.webserviceclient.RequestParams;
import com.ceco.r.gravitybox.webserviceclient.TransactionResult;
import com.ceco.r.gravitybox.webserviceclient.WebServiceClient;
import com.ceco.r.gravitybox.webserviceclient.TransactionResult.TransactionStatus;
import com.ceco.r.gravitybox.webserviceclient.WebServiceClient.WebServiceTaskListener;
...
public class GravityBoxSettings extends GravityBoxActivity implements GravityBoxResultReceiver.Receiver {
    ...
    private static final List<String> lockscreenKeys = new ArrayList<>(Arrays.asList(
            ...
            PREF_KEY_LOCKSCREEN_MEDIA_ART_DISABLE
    ));
...
//            PREF_KEY_HEADS_UP_SNOOZE_TIMER
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Utils.isAppInstalled(this, "com.ceco.q.gravitybox")) {
            ...
            .setPositiveButton(android.R.string.ok, (dialog, which) -> {
                ...
                Uri oldGbUri = Uri.parse("package:com.ceco.q.gravitybox");
    ...
    public static class PrefsFragment extends PreferenceFragment 
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mPrefAboutGb = findPreference(PREF_KEY_ABOUT_GRAVITYBOX);
            ...
            mPrefPieColorReset = findPreference(PREF_KEY_PIE_COLOR_RESET);
            ...
            if (Utils.isSamsungRom()) {
                ...
                Preference p = findPreference(PREF_KEY_INCREASING_RING);
                if (p != null) mPrefCatPhoneTelephony.removePreference(p);
            }
...
//            }
        ...
        public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
            ...
            if (key.equals(PREF_KEY_BATTERY_STYLE)) {
                ...
                if (!enable) {
                    prefs.edit().putBoolean(PREF_KEY_NAVBAR_CUSTOM_KEY_SWAP, false).apply();
                ...
                getActivity().getPackageManager().setComponentEnabledSetting(
                        new ComponentName(getActivity(), "com.ceco.r.gravitybox.GravityBoxSettingsAlias"),
