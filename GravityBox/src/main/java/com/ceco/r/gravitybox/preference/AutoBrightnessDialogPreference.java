...
import com.ceco.r.gravitybox.ModDisplay;
import com.ceco.r.gravitybox.GravityBoxResultReceiver.Receiver;
...
public class AutoBrightnessDialogPreference extends DialogPreference 
    ...
    protected void onBindDialogView(View view) {
        mSpinLevels = view.findViewById(R.id.spinLevels);
        mSpinLevels.setOnItemSelectedListener(this);

        mTxtLux = view.findViewById(R.id.txtLux);
        mTxtBrightness = view.findViewById(R.id.txtBrightness);

        TextView label = view.findViewById(R.id.label2);
        if (label != null) {
