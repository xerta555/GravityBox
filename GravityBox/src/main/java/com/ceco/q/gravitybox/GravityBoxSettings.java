...
import com.ceco.q.gravitybox.shortcuts.GoHomeShortcut;
import com.ceco.q.gravitybox.shortcuts.ShortcutActivity;
import com.ceco.q.gravitybox.tuner.TunerMainActivity;
import com.ceco.q.gravitybox.webserviceclient.RequestParams;
import com.ceco.q.gravitybox.webserviceclient.TransactionResult;
import com.ceco.q.gravitybox.webserviceclient.WebServiceClient;
import com.ceco.q.gravitybox.webserviceclient.TransactionResult.TransactionStatus;
import com.ceco.q.gravitybox.webserviceclient.WebServiceClient.WebServiceTaskListener;
        ...
        public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
            ...
            if (key.equals(PREF_KEY_BATTERY_STYLE)) {
                ...
                getActivity().getPackageManager().setComponentEnabledSetting(
                        new ComponentName(getActivity(), "com.ceco.q.gravitybox.GravityBoxSettingsAlias"),
