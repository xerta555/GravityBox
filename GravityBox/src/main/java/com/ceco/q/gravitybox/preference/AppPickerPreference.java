 ...
 */
package com.ceco.q.gravitybox.preference;
...
import com.ceco.q.gravitybox.GravityBoxSettings.PrefsFragment;
import com.ceco.q.gravitybox.GravityBoxSettings.PrefsFragment.IconPickHandler;
import com.ceco.q.gravitybox.GravityBoxSettings.PrefsFragment.ShortcutHandler;
import com.ceco.q.gravitybox.adapters.BasicIconListItem;
import com.ceco.q.gravitybox.adapters.IIconListAdapterItem;
import com.ceco.q.gravitybox.adapters.IconListAdapter;
...
public class AppPickerPreference extends DialogPreference 
        ...
        new AsyncTask<Void,Void,Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    File appPickerDir = new File(SettingsManager.getInstance(context).getPreferenceDir() + "/app_picker");
    ...
    protected void onBindDialogView(View view) {
        ...
        mListView = view.findViewById(R.id.icon_list);
        mListView.setOnItemClickListener(this);

        mSearch = view.findViewById(R.id.input_search);
        ...
        sPrefsFragment.pickIcon(mIconPickSizePx, new IconPickHandler() {
            ...
            public void onIconPicked(Bitmap icon) {
                try {
                    ...
                    final String dir = SettingsManager.getInstance(context).getPreferenceDir() + "/app_picker";
