...
public class SysUiManagers {
    ...
    public static void init(Context context, XSharedPreferences prefs, XSharedPreferences qhPrefs, XSharedPreferences tunerPrefs) {
        ...
        intentFilter.addAction(com.ceco.oreo.gravitybox.managers.BatteryInfoManager.ACTION_POWER_SAVE_MODE_CHANGING);
        ...
        intentFilter.addAction(com.ceco.oreo.gravitybox.managers.AppLauncher.ACTION_SHOW_APP_LAUCNHER);
