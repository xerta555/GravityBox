...
import com.ceco.oreo.gravitybox.webserviceclient.TransactionResult.TransactionStatus;
import com.ceco.oreo.gravitybox.webserviceclient.WebServiceClient.WebServiceTaskListener;
...
//            PREF_KEY_HEADS_UP_SNOOZE_TIMER
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Utils.isAppInstalled(this, "com.ceco.nougat.gravitybox")) {
            ...
            .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Uri oldGbUri = Uri.parse("package:com.ceco.nougat.gravitybox");
    ...
    public static class PrefsFragment extends PreferenceFragment 
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            notifBgImagePortrait = new File(SettingsManager.getInstance(getActivity()).getPreferenceDir(), "notifwallpaper");
            notifBgImageLandscape = new File(SettingsManager.getInstance(getActivity()).getPreferenceDir(), "notifwallpaper_landscape");
            callerPhotoFile = new File(SettingsManager.getInstance(getActivity()).getPreferenceDir(), "caller_photo");
        ...
        public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
            ...
            if (key.equals(PREF_KEY_BATTERY_STYLE)) {
                ...
                getActivity().getPackageManager().setComponentEnabledSetting(
                        new ComponentName(getActivity(), "com.ceco.oreo.gravitybox.GravityBoxSettingsAlias"),
